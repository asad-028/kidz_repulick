                ...
                ? CarouselSlider(
                    items: activityPhotos!.map((photo) {
                      final String description =
                          (photo['description'] ?? '').toString().trim();
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: InkWell(
                                onTap: () {
                                  final index = activityPhotos!.indexWhere(
                                      (element) =>
                                          element['image_'] == photo['image_']);
                                  if (index != -1) {
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    (photo['image_'] != null &&
                                            (photo['image_'] as String).isNotEmpty)
                                        ? CachedNetworkImage(
