      ...
      bottomNavigationBar: (role_ == "Principal")
                  ...
                  IconButton(
                    ...
                    onPressed: () async => {
                      await confirm(
                          ...
                          : null,
                      if (selectedItemDocumentId != null)
                        {
                          FirebaseFirestore.instance
                              .collection('Activity')
                              .doc(selectedItemDocumentId)
                              .update({'biweeklystatus_': 'Approved'})
                              .then((_) => print(
          ...
          : (role_ == "Parent")
              ? Container(
                  ...
                  child: TextButton(
                    onPressed: () async {
                      await collectionReferenceReports.doc(widget.babyID_).set(
                          {"BiWeekly_Approved": 0}, SetOptions(merge: true));
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //       }
                    //     }
                    //     selectedDateRange = selectedDateRange ?? dateRanges.first;
                    //     final selectedData2 = dateRangeData.firstWhere(
                    //           (element) => element['dateRange'] == selectedDateRange,
                    //       orElse: () => {}, // Return an empty map instead of null
                    //     );
                    //     checkedInCount = selectedData2['checkedInCount'] ; // Handle potential missing value
                    //     absentCount = selectedData2['absentCount'] ; // Handle potential missing value
                    //     selectedItemDocumentId = selectedData2['documentId'];
                    //
                    //     print('ada he wath $selectedDateRange');
                    //     print('ada he wath $checkedInCount');
                    //     print('ada he wath $absentCount');
                    //     // show_now = true;
                    //     return
                    //       Row(
                    //       mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    //             onChanged: (newValue) {
                    //               if (newValue != null && newValue != 'Select Date Range') {
                    //                 setState(() {
                    ...
                    //                     orElse: () => {}, // Return an empty map instead of null
                    //                   );
                    //                   checkedInCount = selectedData['checkedInCount'] ; // Handle potential missing value
                    //                   absentCount = selectedData['absentCount'] ; // Handle potential missing value
                    //                   selectedItemDocumentId = selectedData['documentId'];
                    //                   show_record = role_ != 'Principal';
                    //                 });
                    //               }
                    //             },
                    //             items: [
                    ...
                    //                 enabled: false,
                    //               ),
                    //               ...dateRanges.map<DropdownMenuItem<String>>((String value) {
                    ...
                    StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        dateRangeData.clear();
                        for (var activity in docs) {
                        print('${activity['dateRange']} ${activity['forwardDate']}');
                          var dateRange = activity['dateRange'];
                          var documentId = activity.id;
                          var checkedInCount = activity['checkedin'];
                          var absentCount = activity['absent'];
                          ...
                          StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.connectionState == ConnectionState.waiting) {
                                return Center(
                                  child: Padding(
                                    padding: EdgeInsets.only(top: mQ.height * 0.3),
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: entry.value.map((activity) {
                                                    return (activity['biweeklystatus_'] !=
                                                        'Approved' &&
                                                        role_ == 'Parent')
                                                        ? Container()
                                                        : Column(
