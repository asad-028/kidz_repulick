...
class ParentDailySheetScreen extends StatefulWidget {
  ...
  ParentDailySheetScreen({
    ...
    this.boxheading,
    this.boxheight_,
    required this.boxcolor_,
    required this.boxwidth_,
...
class _ParentDailySheetScreenState extends State<ParentDailySheetScreen> {
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                ...
                child: (widget.boxheading == 'Checked In')
                    ? (activityData['Activity'] == 'Checked In' ||
                            activityData['Activity'] == 'Absent')
                        ? Text(
                    ...
                    : (widget.boxheading == 'Checked Out')
                        ...
                        : (widget.subject == 'Attendance')
                            ? printattendance(
                                activityData, mQ, widget.boxheading)
                            : (widget.subject == 'Food')
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height: mQ.height * 0.035,
                        child: TextField(
                          controller: time_text_controller,
                          enabled: _isEnable,
                        )),
                  ],
                ),
      ...
      children: [
        Text('${activityData['Activity']} ${activityData['time_']}',
            style: k12500.copyWith(
                fontWeight: FontWeight.bold, color: widget.subjectcolor_)),
        Text('${activityData['description']} ',
            style: k12500.copyWith(color: kBlackColor)),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          if (activityData['description'] != null &&
              activityData['description'].isNotEmpty)
            Text('${activityData['description']} ',
                style: kGrey15500.copyWith(color: kGrey)),
        ],
      ),
    );
  }
  ...
  printattendance(activityData, mQ, status_) {
    return (activityData['Activity'] == 'Checked In' ||
            activityData['Activity'] == 'Absent')
        ? Expanded(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('${activityData['description']} ',
              style: k14500.copyWith(color: kBlackColor)),
        ],
      ),
    );
  }
