...
class ManagerReportSelectChild extends StatefulWidget {
  ...
  @override
  State<ManagerReportSelectChild> createState() =>
      _ManagerReportSelectChildState();
}
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            (role_ == "Teacher")
                ? classwisestudents(teachersClass_)
                : Container(),
            (role_ == "Teacher") ? Container() : classwisestudents('Infant'),
            (role_ == "Teacher") ? Container() : classwisestudents('Toddler'),
            (role_ == "Teacher")
                ? Container()
                              ...
                              Column(
                                ...
                                children: [
                                  PopupMenuButton<String>(
                                        ...
                                        image: DecorationImage(
                                          ...
                                          image: (childData['picture'] !=
                                              ...
                                              ? CachedNetworkImageProvider(
                                                  childData['picture'])
                                              : AssetImage('assets/staff.jpg')
                                                  as ImageProvider, // Fallback to a local asset or placeholder
                                    ...
                                    color: Colors.purple[
                                        50], // Generate the menu items from the list
                                          ...
                                          ? (selectedItem == 'Daily')
                                              ...
                                              : (selectedItem == 'Forwarded')
                                                  ...
                                                  : (selectedItem == 'Approved')
                                                      ...
                                                      : (selectedItem == 'New')
                                                          ? Get.to(DailyReportShape(babyID_: snapshot.data!.docs[position].id, name_: childData['childFullName'], date_: reportDate_, class_: childData['class_'], childPicture_: childData['picture'], reportType_: 'New'))
                                                          : (selectedItem == 'Activities')
                                                              ? Get.to(GalleryReportShapeScreen(
                                                                  babyID_: snapshot
                                                                      .data!
                                                                      .docs[
                                                                          position]
                                                              ...
                                                              : (role_ != 'Teacher')
                                                                  ...
                                                                  : Get.to(BiWeeklyReportShapeScreen(
                                                                      babyID_: snapshot
                                                                          .data!
                                                                          .docs[
                                                                              position]
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
            ...
            Positioned(
              top: 0,
              left: photosnew_ > 0 ? leftposn += 14 : leftposn,
              child: CircleAvatar(
                radius: 8,
                backgroundColor:
            ...
            Positioned(
              top: 0,
              left: biweekly > 0 ? leftposn += 14 : leftposn,
              child: CircleAvatar(
                radius: 8,
                backgroundColor:
            ...
            if (role_ == 'Teacher')
              Positioned(
                top: 0,
                left: newVar > 0 ? leftposn += 14 : leftposn,
                child: CircleAvatar(
                  radius: 8,
                  backgroundColor:
                      newVar > 0 ? Colors.green : Colors.transparent,
                  child: Text(
                    newVar.toString(),
                    style: TextStyle(
            ...
            if (role_ == 'Principal')
              Positioned(
                top: 0,
                left: forwardVar > 0 ? leftposn += 14 : leftposn,
                child: CircleAvatar(
                  radius: 8,
                  backgroundColor:
            ...
            if (role_ == 'Director' || role_ == 'Parent')
              Positioned(
                top: 0,
                left: approvedVar > 0 ? leftposn += 14 : leftposn,
                child: CircleAvatar(
                  radius: 8,
                  backgroundColor:
                      approvedVar > 0 ? Colors.red : Colors.transparent,
                  child: Text(
                    approvedVar.toString(),
                    style: TextStyle(
                      color:
                          approvedVar > 0 ? Colors.white : Colors.transparent,
                      fontSize: 7,
                    ),
                  ),
                ),
  ...
  Widget checkNewPhotoReportsAndShowBadge(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return Positioned(
            top: 0,
            left: newPhotoVar > 0 ? leftposn += 14 : leftposn,
            child: CircleAvatar(
                radius: 8,
                backgroundColor:
                    newPhotoVar > 0 ? Colors.purple : Colors.transparent,
                child: Text(
  ...
  Future selectReportDate(BuildContext context) async {
    final DateTime? pickedStartDate = await showDatePicker(
        ...
        firstDate: DateTime(
          DateTime.now().year,
          DateTime.now().month,
          (role_ == 'Parent') ? DateTime.now().day - 1 : DateTime.now().day - 3,
        ),
        lastDate: DateTime(
          DateTime.now().year,
          DateTime.now().month,
    ...
    if (pickedStartDate != null) {
      ...
      setState(() {
        displayReportDate_ =
            ' ${DateFormat.EEEE().format(now)},  ${DateFormat.d().format(now)} ${DateFormat.MMMM().format(now)} ${DateFormat.y().format(now)} ';
      });
