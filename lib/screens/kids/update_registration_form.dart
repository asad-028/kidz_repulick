...
class _UpdateRegistrationFormState extends State<UpdateRegistrationForm> {
  ...
  UpdateRegistrationFormController updateRegistrationFormController =
      Get.put(UpdateRegistrationFormController());
      ...
      bottomNavigationBar: Obx(
        () => updateRegistrationFormController.isLoading.value
            ...
            : SizedBox(
                ...
                child: PrimaryButton(
                  onPressed: () {
                    updateRegistrationFormController.UpdateChildFunction(
                        context, widget.babyId);
                  },
                  label: "Update",
                  elevation: 3,
                  bgColor: kprimary,
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  controller:
                      updateRegistrationFormController.nameUsuallyKnownBy,
                  inputType: TextInputType.text,
                ...
                CustomTextField(
                  controller:
                      updateRegistrationFormController.mothersmobilePhoneNo,
                  inputType: TextInputType.text,
                ...
                CustomTextField(
                  controller:
                      updateRegistrationFormController.mothersEmailAddress,
                  inputType: TextInputType.text,
                ...
                Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      updateRegistrationFormController.selectDate(
                          "Registration Date", context),
                      (updateRegistrationFormController.datechanged)
                          ? Text(
                              '${updateRegistrationFormController.getCurrentDate()}')
  ...
  uploadimagetocloudstorage(imagefile) async {
    ...
    final filename =
        "images/ ${updateRegistrationFormController.childFullName.text}${DateTime.now()}";
  ...
  Future<void> fetchdataintoformChildFunction(
    ...
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          // doc(babyId).update({
          updateRegistrationFormController.childFullName.text =
              snapshot.get("childFullName");
          imageUrl = snapshot.get("picture");
          updateRegistrationFormController.fathersName.text =
              snapshot.get("fathersName");
          updateRegistrationFormController.fathersEmail.text =
          ...
          updateRegistrationFormController.homePhone.text =
              snapshot.get("homePhone");
          updateRegistrationFormController.mothersName.text =
              snapshot.get("mothersName");
          ...
          updateRegistrationFormController.mothersworkPhoneNo.text =
              snapshot.get("mothersworkPhoneNo");
          updateRegistrationFormController.mothersmobilePhoneNo.text =
              snapshot.get("mothersmobilePhoneNo");
          updateRegistrationFormController.mothersEmailAddress.text =
              snapshot.get("mothersEmailAddress");
          ...
          updateRegistrationFormController.fathersWorkPhoneNo.text =
              snapshot.get("fathersWorkPhoneNo");
          updateRegistrationFormController.fathersMobileNo.text =
          ...
          updateRegistrationFormController.RegistrationDate.text =
              snapshot.get("RegistrationDate");
